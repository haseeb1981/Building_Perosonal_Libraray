...
class BookCollection:
    ...
    def update_book(self):
        ...
        for book in self.book_list:
            if book["title"].lower() == book_title.lower():
                ...
                read_input = input(f"Have you read it? (yes/no) [{ 'yes' if book['read'] else 'no' }]: ").lower()
    ...
    def show_reading_progress(self):
        ...
        completed_rate = (completed_books / total_books * 100) if total_books > 0 else 0
    ...
    def start_application(self):
        """Run the main application loop with a menu."""
        while True:
